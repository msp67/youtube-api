...
```json
{
  ...
  "statusCode": 200,
  "data": {
    "channelId": "UC0IpGYsi1KVorZ7QVCHfdag",
    "title": "Binz Da Poet",
    "description": "Binz (24/05/1988) - singer/songwriter/rapper/producer...",
    "thumbnails": [
      {
    ...
    "vanityChannelUrl": "http://www.youtube.com/@BinzDaPoet",
    "keywords": ["binz", "binz official", "binz le"],
    "stats": {
      "subscribers": 1880000,
